...
module.exports.createServer = function (
    ...
    let dropWidgetPath = path.join(__dirname, './../drop');
    app.use('/drop', express.static(dropWidgetPath));
    app.use('/drop', serveIndex(dropWidgetPath));
    ...
    webServer.on('listening', function () {
        ...
        logger.info([
            ...
            `\tUpload drop         : ${colors.green(serverAddress + '/drop')}`,
            '',
        ].join('\n')
        )
